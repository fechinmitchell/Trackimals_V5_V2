                ...
                .addOnCompleteListener(RegisterActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()){
                            ...
                            hashMap.put("bio", "");
                            hashMap.put("imgaeurl", "https://firebasestorage.googleapis.com/v0/b/trackimals-v5.appspot.com/o/placeholder.png?alt=media&token=b84f539f-a99f-4548-8e6f-faf0dc75bddc");
